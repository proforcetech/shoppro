...
var VehiclesController = function () {
    var _classDecorators = [(0, common_1.Controller)('vehicles'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var VehiclesController = _classThis = /** @class */ (function () {
        ...
        VehiclesController_1.prototype.create = function (dto) {
            return this.vehiclesService.create(dto);
        };
        VehiclesController_1.prototype.findAll = function () {
            return this.vehiclesService.findAll();
        };
        VehiclesController_1.prototype.findOne = function (id) {
            return this.vehiclesService.findOne(id);
        };
        VehiclesController_1.prototype.update = function (id, dto) {
            return this.vehiclesService.update(id, dto);
        };
        VehiclesController_1.prototype.remove = function (id) {
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)(), (0, role_decorator_1.Roles)('FRONT_DESK')];
        _findOne_decorators = [(0, common_1.Get)(':id')];
        _update_decorators = [(0, common_1.Put)(':id'), (0, role_decorator_1.Roles)('MANAGER')];
        _remove_decorators = [(0, common_1.Delete)(':id'), (0, role_decorator_1.Roles)('ADMIN')];
