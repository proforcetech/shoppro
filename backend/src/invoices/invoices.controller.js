...
var InvoicesController = function () {
    ...
    var InvoicesController = _classThis = /** @class */ (function () {
        function InvoicesController_1(invoicesService, pdfService, prisma, emailService) {
        ...
        InvoicesController_1.prototype.update = function (id, dto) {
        ...
        InvoicesController_1.prototype.generatePdf = function (id, res) {
            return __awaiter(this, void 0, void 0, function () {
                var invoice, estimate, vehicle, customer, pdfUrl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.estimate.findUnique({
                        ...
                        case 5:
                            pdfUrl = _a.sent();
                            res.download("public/".concat(pdfUrl.split('/').pop()));
                            return [2 /*return*/];
                    }
                });
            });
        ...
        InvoicesController_1.prototype.sendInvoiceEmail = function (id, res) {
            return __awaiter(this, void 0, void 0, function () {
                var invoice, estimate, vehicle, customer, pdfUrl, absolutePath;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.invoicesService.findOne(id)];
                        case 1:
                        ...
                        case 5:
                            pdfUrl = _a.sent();
                            absolutePath = "public/".concat(pdfUrl.split('/').pop());
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), Roles('MANAGER')];
        _findAll_decorators = [(0, common_1.Get)(), Roles('FRONT_DESK')];
        _findOne_decorators = [(0, common_1.Get)(':id')];
        _update_decorators = [(0, common_1.Put)(':id'), Roles('MANAGER')];
        _addPayment_decorators = [(0, common_1.Patch)('payment'), Roles('FRONT_DESK')];
        _remove_decorators = [(0, common_1.Delete)(':id'), Roles('ADMIN')];
        _generatePdf_decorators = [(0, common_1.Get)(':id/pdf'), Roles('FRONT_DESK')];
        _sendInvoiceEmail_decorators = [(0, common_1.Post)(':id/email'), Roles('FRONT_DESK')];
