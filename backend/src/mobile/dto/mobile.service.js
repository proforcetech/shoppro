...
var MobileService = function () {
    ...
    var MobileService = _classThis = /** @class */ (function () {
        ...
        MobileService_1.prototype.handleMobileJob = function (apptId, invoiceId, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var appt, invoice, vehicleId, mileage, mileageRate, mileageFee, dispatchFee;
                var _a, _b, _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            appt = _d.sent();
                            if (!appt) {
                                throw new common_1.NotFoundException("Appointment with ID ".concat(apptId, " not found"));
                            }
                        ...
                        case 2:
                            invoice = _d.sent();
                            if (!((_a = invoice === null || invoice === void 0 ? void 0 : invoice.estimate) === null || _a === void 0 ? void 0 : _a.vehicleId)) {
                                throw new Error('Invoice or associated estimate.vehicleId is missing');
                            }
                            vehicleId = invoice.estimate.vehicleId;
                            mileage = (_b = appt.mileage) !== null && _b !== void 0 ? _b : 0;
                            mileageRate = 0.5;
                            mileageFee = mileage * mileageRate;
                            dispatchFee = (_c = appt.dispatchFee) !== null && _c !== void 0 ? _c : 0;
