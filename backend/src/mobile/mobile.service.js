...
var MobileService = function () {
    ...
    var MobileService = _classThis = /** @class */ (function () {
        ...
        MobileService_1.prototype.configureMobileJob = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var appointmentId, isMobile, _a, dispatchFee, _b, mileage, appt;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            appointmentId = dto.appointmentId, isMobile = dto.isMobile, _a = dto.dispatchFee, dispatchFee = _a === void 0 ? 50 : _a, _b = dto.mileage, mileage = _b === void 0 ? 0 : _b;
        ...
        MobileService_1.prototype.applyMobileFeesToInvoice = function (invoiceId) {
            return __awaiter(this, void 0, void 0, function () {
                var invoice, appt, mileageRate, mileageFee, dispatchFee;
                var _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            if (!invoice.estimate)
                                throw new common_1.NotFoundException('Estimate not found for invoice');
                        ...
                        case 2:
                            appt = _c.sent();
                            if (!(appt === null || appt === void 0 ? void 0 : appt.isMobile))
                                return [2 /*return*/, invoice];
                            mileageRate = 1.5;
                            mileageFee = ((_a = appt.mileage) !== null && _a !== void 0 ? _a : 0) * mileageRate;
                            dispatchFee = (_b = appt.dispatchFee) !== null && _b !== void 0 ? _b : 0;
