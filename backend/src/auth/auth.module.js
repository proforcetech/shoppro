...
var auth_service_1 = require("./auth.service"); // Keep this one
var jwt_strategy_1 = require("./jwt.strategy");
var users_module_1 = require("../users/users.module");
var auth_controller_1 = require("./auth.controller"); // <--- ADD THIS IMPORT
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [auth_controller_1.AuthController], // Now AuthController should be found
        })];
